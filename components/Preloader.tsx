...
export const Preloader: React.FC<PreloaderProps> = ({ isVisible, t }) => {
  ...
  return (
    <div 
      className={`fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-r-light dark:bg-r-dark transition-opacity duration-500 ease-out pointer-events-none ${
