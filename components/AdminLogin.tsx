        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <input 
              ...
              className="w-full bg-[#f2f2f2] dark:bg-[#1a1a1a] border border-transparent focus:border-black dark:focus:border-white p-4 text-sm outline-none transition-colors"
